...
public class question3{
	...
	public static void main(String[] args) {
		...
		employees.add(new Employee(1, "ammu","IT",56000));
        employees.add(new Employee(4, "chenna","IT",50000));
        employees.add(new Employee(3, "Kesava","IT",30000));
        employees.add(new Employee(2, "sree","IT",90760));
        employees.add(new Employee(4, "keerthi","IT",67000));
