...
public class question1 {
	...
	List<News> news=Arrays.asList(
			new News(101,"Naveen","Ramu","hi"),
			new News(102,"Ramu","Naveen","hello"),
			new News(103,"Ramu","Rocky","namaste"),
			new News(104,"Rocky","Naveen","vanakkam")
			);
		Trader t1=new Trader("Chintu","Indore");
		Trader t2=new Trader("Banti","Pune");
		Trader t3=new Trader("Naveen","Pune");
		Trader t4=new Trader("Rocky","Delhi");
	...
	System.out.println("\t1.Display fruit Names of calories<100");
	fruit.stream()
		    .filter(i -> i.getCalaries() <100)
		    .forEach(f->System.out.println(f.getName()));
	System.out.println("\n\t2.colorWise list of names ");
	fruit.stream()
		.collect(Collectors.toList())
	    .forEach(i->System.out.println(i.getName()+"\t"+i.getColor()));
	System.out.println("\n\t3.Red colorlist of names ");
	fruit.stream()
	...
	System.out.println("\n\t4.news ID Which received most comments");
	for(News i:news) {
	...
	//Que5
			...
			System.out.println("5.budget appeared in comments "+count+" times");
	//Que6
	System.out.println("\n\t6.Most commented by the user");
	...
	//Que8
	System.out.println("\n\t8.2011 transactions And sorting them in order");
	...
	//Que 9
			System.out.println("\n\t9.Unique City Where customers work");
			...
			//Que10
			System.out.println("\n\t10.Traders from pune in sorting order");
